import { onBeforeMount } from 'core/hooks/lifecycle/beforeMount'
import { onMounted } from 'core/hooks/lifecycle/mounted'
import { hasSetupRunning } from 'core/hooks/lifecycle/verifySetup'
import { nextTick } from 'core/utils/AutoAsyncTask'
import { isAsyncFunction, isFunction } from 'core/utils/shared'
